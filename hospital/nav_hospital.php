...
$hospital_name = $_SESSION['institution_name'] ?? 'Hospital Panel';
?>
...
<aside class="sidebar" id="sidebarMenu">
    ...
    <ul class="nav flex-column mb-auto px-2">
        <li class="nav-item">
            <a class="nav-link <?= ($current_page == 'index_hospital.php') ? 'active' : '' ?>" href="index_hospital.php">
                <i class="bi bi-house-door me-2"></i> Dashboard
            </a>
        </li>
        <li class="nav-item">
            <a class="nav-link <?= ($current_page == 'emergency_requests.php') ? 'active' : '' ?>" href="emergency_requests.php">
                <i class="bi bi-bell me-2"></i> Emergency Requests
            </a>
        </li>
        <li class="nav-item">
            <a class="nav-link <?= ($current_page == 'events_hospital.php') ? 'active' : '' ?>" href="events_hospital.php">
                <i class="bi bi-calendar-event me-2"></i> Events
            </a>
        </li>
        <li class="nav-item">
            <a class="nav-link <?= ($current_page == 'account_hospital.php') ? 'active' : '' ?>" href="account_hospital.php">
