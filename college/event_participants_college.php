...
if (!isset($_GET['event_id'])) {
    header("Location: events_college.php");
    exit;
}
...
if (isset($_GET['attend_id'])) {
    ...
    header("Location: event_participants_college.php?event_id=" . $event_id);
    exit;
}
...
<head>
    <meta charset="UTF-8">
    <title>Events - College Dashboard</title>
                        ...
                        <?php foreach ($participants as $row): ?>
                            <tr>
                                ...
                                <td>
                                    ...
                                    <?php else: ?>
                                        <a href="event_participants_college.php?event_id=<?= $event_id ?>&attend_id=<?= $row['participation_id'] ?>"
                                ...
                                <td>
                                    ...
                                    <?php elseif ($row['attended']): ?>
                                        <a href="event_participants_college.php?event_id=<?= $event_id ?>&donate_id=<?= $row['participation_id'] ?>"
